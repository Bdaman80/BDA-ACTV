 ...
 *
 * Author: Georgi Vlaev <office@nucleusys.com>
 *
...
extern int headset_connected;
extern int has_vol_controls;
extern int codec_suspended;
extern struct cpcap_device *cpcap;
extern struct snd_soc_codec *cs42l73_codec;
extern struct snd_soc_dai cs42l73_dai[];
extern struct snd_soc_codec_device soc_codec_dev_cs42l73;
extern unsigned short read_mic_adc(struct cpcap_device *cpcap);
